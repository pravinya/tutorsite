...
class getLogIn extends CAction{
	  ...
	  case 2:
             ...
             $this->getController()->render('application.components.widgets.join.views.login',array('login_model'=>$lfmodel,'fbUser'=>$this->fbProfile,)); 
             break;
	      ...
	      //   if (Yii::app()->request->isAjaxRequest){
             ...
             $this->getController()->render('application.components.widgets.join.views.register',array('model'=>$model,'fbUser'=>$this->fbProfile)); 
             break;
