...
<?php
  ...
  $form=$this->beginWidget('CActiveForm', array(
		...
		'htmlOptions'=>array('class'=>'formoid-default','style'=>'background-color:#7ddfe0;font-size:14px;font-family:"Open Sans",Arial,Verdana,sans-serif;width:315px;max-width:100%;margin-left:8px;padding:6px;')
	));
  
    ?>
    <div id="contact-error-div" class="alert alert-danger" style="color:#fff;display:none;"> </div>
      <div id="fancy_header" >
	<div class="element-input" title='Please Give your name'>
		...
		<span class="tooltipster-icon">(?)</span>
	         <?php echo CHtml::activeTextField($contact_model,'name',array('maxlength'=>255, 'class' => 'publish_input', 'style' => 'width:179px;height:38px;', 'tabindex' => 1)); ?>
        </div>
	<div class="element-input">
		<?php echo CHtml::activeLabelEx($contact_model,'email', array('label' => Yii::t('publish_page', 'Your Email'),'class'=>'title'));?>
		
	         <?php echo CHtml::activeTextField($contact_model,'email',array('maxlength'=>255, 'class' => 'publish_input', 'style' => 'width:179px;height:38px;', 'tabindex' => 1)); ?>
        </div>
	<div class="element-input">
		<?php echo CHtml::activeLabelEx($contact_model,'mobile', array('label' => Yii::t('publish_page', 'Your Mobile Number'),'class'=>'title'));?>
		
	         <?php echo CHtml::activeTextField($contact_model,'mobile',array('maxlength'=>255, 'class' => 'publish_input', 'style' => 'width:179px;height:38px;', 'tabindex' => 1)); ?>
        </div>
	<div class="element-input">
